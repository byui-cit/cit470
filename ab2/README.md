...
### Tools
On one or more of your team's virtual machines, install [Wireshark](https://www.wireshark.org/), a software utility for capturing and analyzing network traffic.
